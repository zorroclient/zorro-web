...
// Scroll motion for /lab-hud: layered hero parallax ("mountains" depth — each
// layer drifts at its own rate so the figure recedes while the reticle/labels
// float), plus Lenis smooth-scroll and on-enter section reveals. Motion hooks
// are data-attributes so this never depends on hashed CSS-module class names.
//
